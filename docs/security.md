...
Checkyは、Discord上のイベント管理および連絡確認を行うBotであり、以下の観点からセキュリティ対策を実施しています。

---

# 1. Discordリクエスト検証

Checkyは、Discordから送信されたリクエストであることを検証しています。
...
Checkyは複数のDiscordサーバーで使用されることを想定しています。
...
Checkyは **Bot自身が投稿したメッセージのみ編集**します。
